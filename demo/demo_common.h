...
int demo_sockaddr_to_kcpmux_addr(const struct sockaddr_in *addr, kcpmux_addr_t *out,
                                 uint8_t out_buf[6]);
...
int demo_endpoint_init(demo_endpoint_t *endpoint,
...
int demo_write_socket(const uint8_t *buf, unsigned size, const kcpmux_addr_t *addr,
                      void *user_data);
